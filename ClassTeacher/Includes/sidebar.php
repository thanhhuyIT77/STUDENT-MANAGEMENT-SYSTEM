       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewStudents.php">Xem học sinh</a>
      ...
      Điểm danh
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Quản lý điểm danh</h6>
            <a class="collapse-item" href="takeAttendance.php">Thực hiện điểm danh</a>
            <a class="collapse-item" href="viewAttendance.php">Xem điểm danh theo lớp</a>
            <a class="collapse-item" href="viewStudentAttendance.php">Xem điểm danh theo học sinh</a>
            <a class="collapse-item" href="downloadRecord.php">Báo cáo hôm nay (xls)</a>
