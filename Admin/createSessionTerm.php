       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tạo năm học và học kỳ</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tạo năm học và học kỳ</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Tên năm học<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="sessionName" value="<?php echo isset($row['sessionName']) ? $row['sessionName'] : '';?>" id="exampleInputFirstName" placeholder="Năm học">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">Học kỳ<span class="text-danger ml-2">*</span></label>
                              <?php
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Danh sách năm học và học kỳ</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Lưu ý: <i>Bấm vào biểu tượng dấu tích để kích hoạt năm học và học kỳ!</i></h6>
                </div>
